...
def load_dataset():
    ...
    X_train = load_mnist_images('MNIST-data/train-images-idx3-ubyte.gz')
    y_train = load_mnist_labels('MNIST-data/train-labels-idx1-ubyte.gz')
    X_test = load_mnist_images('MNIST-data/t10k-images-idx3-ubyte.gz')
    y_test = load_mnist_labels('MNIST-data/t10k-labels-idx1-ubyte.gz')
...
def build_cnn(input_var=None):
    # As a model, we create a CNN of two convolution + pooling stages
...
if __name__ == '__main__':
    main(50) # 40.000 images in batches of 100 --> 40.000/100 = 400 steps per epoch
